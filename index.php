...
<html lang="en">
	...
	?>
		...
		<!--	<div class="logo">
			...
			<br />
			<p style="font-size:20px;color:white">A small attempt to change !!!</p>
			<br />
		</div>
		...
		<div class="footer-center" style="text-align: center">
			...
			<div>
				...
				<p style="font-size:20px"><a href="mailto:Krishir-Pothe@gmail.com" style="color:white">example@gmail.com</a></p>
			</div>
		</div>
